...
import os, bentoml, typing, logging, pydantic, fastapi, typing_extensions, annotated_types, fastapi.staticfiles as staticfiles, fastapi.responses as responses

logger = logging.getLogger("bentoml.service")


class BentoArgs(pydantic.BaseModel):
    openllm_model_id: str = "deepseek-ai/DeepSeek-V3"
